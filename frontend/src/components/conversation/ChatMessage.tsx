...
export default function ChatMessage({message}: any) {
  ...
  const outerClass =  (message.is_owned) ? "d-flex flex-row-reverse mb-4 " : "d-flex flex-row mb-4";
  ...
  return (
        ...
        style={{
          gap: '20px', fontSize: '1rem', justifyContent: justifyContent,
        }}
        >
          {/* avatar image */}
          <div
          className=""
          style={{
            width: '3em', height: '3em', placeContent: 'center', display:'grid', borderRadius: '50%',
            backgroundColor: Colors.NavyBlue, color:"white",
          }}
          >
          ...
          className="d-flex"
          style={{
            fontSize: '0.8em', fontWeight: 300, padding: '0.8em 1em', width: 'fit-content', height: 'fit-content',
